...
export const metadata = {
  title: 'Aristobyte UI Sandbox',
  description: 'Local sandbox for Aristobyte UI components.',
};

export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body className={`${workSans.variable} ${unisonPro.variable} ${righteous.variable}`}>{children}</body>
    </html>
  );
}
