export const EN_GB = {
  ...
  layout: {
    ...
    commonDescriptions: {
      ...
      installationIndividualPackage: 'Install only the <b>{{package}}</b> if you need specific functionality.',
      installationFullLibrary: 'Skip this if you have the complete <b>@aristobyte-ui</b> already installed.',
      import:
      ...
      importIndividualPackageAltText: 'Recommended for component-specific usage',
      importGlobalLibrary:
    ...
    components: {
      anchor: {
        intro: {
          title: 'Anchor',
          description:
            'The Anchor component provides a styled, accessible link element with consistent variants for navigation and in-app linking.',
        },
        installation: {
          title: 'Installation of Anchor',
          description:
            'The above command is for individual installation of Anchor only. You may skip this step if <b>@aristobyte-ui</b> is already installed globally.',
        },
        import: {
          title: 'Import Anchor',
          description:
            'Anchor offers a consistent link experience across your UI. Import it directly from the package to keep navigation styling uniform.',
        },
        variants: {
          title: 'Anchor Variants',
          description: 'Choose from semantic variants to match surface and intent across layouts.',
          guidelines: {
            title: 'Guidelines',
            subtitle1: 'Usage',
            list1: {
              element1: 'Use <b>primary</b> for key navigation links and CTAs.',
              element2: 'Keep <b>default</b> for neutral inline links.',
              element3: 'Use <b>error</b> or <b>warning</b> for critical notices only.',
              element4: 'Avoid mixing too many variants within a single block of text.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Ensure sufficient contrast for accessibility in all variants.',
              element2: 'Keep hover states consistent across sections.',
              element3: 'Prefer variants that align with your product color system.',
              element4: 'Use <b>white</b> or <b>black</b> variants for themed surfaces.',
            },
          },
        },
        targets: {
          title: 'Link Targets',
          description: 'Control whether the link opens in the same tab or a new tab using the <b>target</b> prop.',
          guidelines: {
            title: 'Guidelines',
            subtitle1: 'Usage',
            list1: {
              element1: 'Use <b>_blank</b> for external destinations.',
              element2: 'Prefer <b>_self</b> for internal navigation.',
              element3: 'Inform users when a new tab will open.',
              element4: 'Avoid overusing new-tab navigation.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Pair <b>_blank</b> with <code>rel="noreferrer"</code> when needed.',
              element2: 'Keep target values explicit for clarity.',
              element3: 'Use consistent behavior across the same page.',
              element4: 'Document any exceptions in UX guidelines.',
            },
          },
        },
      },
      button: {
        ...
        disabled: {
          ...
          guidelines: {
            ...
            list1: {
              element1: 'Gate actions during async processing or unmet prerequisites.',
              element2: 'Prevent destructive ops when user lacks authorization.',
              element3:
                'Disable during automatic retries or pending network reconciliation to avoid duplicate side-effects.',
              element4: 'Conditionally disable when dependent form fields are invalid or validation is in-flight.',
            },
            subtitle2: 'Developer Tips',
            list2: {
              element1: "Pair with tooltip or helper text to explain why it's disabled.",
              element2: 'Maintain focus order; use aria-disabled for non-native buttons.',
              element3: 'Expose semantic attributes (data-disable-reason) for telemetry and test automation.',
              element4: 'Ensure disabled visuals are covered by unit/integration tests to prevent regressions.',
            },
          },
        },
        sizes: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element2: 'Use larger sizes for primary CTAs and mobile ergonomics.',
              element3: 'Prefer consistent padding tokens across sizes to maintain rhythm across components.',
              element4:
            ...
            list2: {
              ...
              element2: 'Respect minimum hit area (~44×44px) for touch targets.',
              element3: 'Provide clear size mapping in component docs so consumers can programmatically choose sizes.',
              element4:
        ...
        radius: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use tokenized radius values to preserve cross-component consistency.',
              element4:
            ...
            list2: {
              ...
              element2: 'Maintain consistent radius across button + dropdown combos.',
              element3: 'When theming, provide a clear override strategy to prevent accidental radius fragmentation.',
              element4: 'Verify radius rendering at scale with visual regression snapshots to catch clipping issues.',
            },
          },
        },
        colors: {
          ...
          guidelines: {
            ...
            list1: {
              element1: 'Map semantic actions to tokenized variants (e.g., success).',
              element2: 'Reserve brand-primary for the single most important CTA.',
              element3: 'Use neutral/ghost colors for low-impact utilities to reduce visual noise.',
              element4: 'Align variant palettes with accessibility contrast checks during theme builds.',
            },
            ...
            list2: {
              ...
              element3: 'Test color variants under different user themes (dark/light/high-contrast).',
              element4: 'Document fallback color behavior for brand tokens that may not exist in consumer themes.',
            },
          },
        },
        variants: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use neutral variants for contextual actions that should not compete visually with CTAs.',
              element4:
            ...
            list2: {
              ...
              element2: 'Use destructive (error) variant only for irreversible ops.',
              element3: 'Instrument variant usage to track UX patterns and detect misuse across large apps.',
              element4: 'Provide clear migration notes when changing the default variant mapping in a major release.',
            },
          },
        },
        appearance: {
          ...
          guidelines: {
            ...
            subtitle1: 'Design Considerations',
            list1: {
              element1: 'Use solid for CTAs; outline for secondary/inverse surfaces.',
              ...
              element4: 'Use glowing sparingly and reserve for micro-interactions or marketing surfaces only.',
            },
            ...
            list2: {
              ...
              element3: 'Avoid heavy box-shadow/glow on many elements simultaneously to keep paint budgets reasonable.',
              element4:
        ...
        loading: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element2: 'Lock repetitive triggers to prevent duplicate requests.',
              element3: 'Use loading states for multi-step workflows where intermediate state persists across screens.',
              element4: 'Prefer inline loaders rather than full-overlay loaders for non-blocking operations.',
            },
            subtitle2: 'Continuity & UX',
            list2: {
              element1: 'Swap label to progress-friendly copy (e.g., “Saving…”).',
              element2: 'Restore focus to the button on completion for continuity.',
              element3: 'Provide ARIA live updates where appropriate to announce completion to assistive tech.',
              element4: 'Ensure spinner animation is paused or simplified in low-power modes.',
            },
          },
        },
        'with-icon': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element2: 'Icon-only buttons require accessible labels (aria-label).',
              element3: 'Prefer a single icon library for consistency in stroke/weight across the UI.',
              element4: 'Align icon metrics to text baseline to avoid optical misalignment in mixed-size buttons.',
            },
            ...
            list2: {
              ...
              element3: 'Provide accessible name via aria-label when children are omitted.',
              element4: 'Avoid animating icon layout shifts during label/content changes to prevent reflow.',
            },
          },
        },
        'button-group': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Apply for quick-action rows where grouping reduces cognitive load.',
              element4: 'Use grouped buttons for responsive toolbars that collapse into menus on narrow viewports.',
            },
            ...
            list2: {
              ...
              element3: 'Ensure focus ring and selected-state visuals are propagated consistently.',
              element4: 'Do not mix unrelated actions inside a single group; prefer contextual separation.',
            },
          },
        },
        'button-group-disabled': {
          ...
          guidelines: {
            ...
            list1: {
              element1: 'Disable an entire cluster when upstream state blocks all.',
              element2: 'Use to prevent partial interaction in multi-step flows.',
              element3: 'Use group-level disabling for transactional flows awaiting backend confirmation.',
              element4: 'Leverage disabled groups during role-based access reviews to reduce per-button overrides.',
            },
            subtitle2: 'Developer Notes',
            list2: {
              element1: 'Communicate why the group is disabled (tooltip/helper).',
              element2: 'Allow granular overrides only when explicitly required.',
              element3: 'Expose a single override API for exceptions to avoid prop explosion.',
              element4: 'Document precedence rules when child-level disables differ from group-level.',
            },
          },
        },
        'button-group-alignment': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Switch alignment responsively for smaller breakpoints to preserve touch targets.',
              element4:
            ...
            list2: {
              ...
              element3: 'When stacking vertically, ensure accessible hit area and consistent vertical rhythm.',
              element4: 'Support reverse ordering for RTL locales and document expected behavior.',
            },
          },
        },
        'button-group-radius': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Apply appropriate clipping rules to avoid adjacent element overlap when using large radii.',
              element4:
            ...
            list2: {
              ...
              element2: 'Ensure first/last items visually cap the group correctly.',
              element3: 'Provide utilities to normalize border-radius when combining with external wrappers.',
              element4: 'Validate radius combinations visually in both LTR and RTL contexts.',
            },
          },
        },
        'button-group-size': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use group sizes to enforce visual parity across dynamic button sets.',
              element4: 'Prefer size tokens that map directly to spacing and typography scales.',
            },
            subtitle2: 'Implementation Notes',
            list2: {
              element1: 'Do not mix sizes inside the same group.',
              element2: 'Respect vertical rhythm across stacked groups.',
              element3: 'Expose size-related CSS variables for consumer overrides when necessary.',
              element4: 'Document responsive size behavior (e.g., auto-scaling on smaller viewports).',
            },
          },
        },
        'button-group-variant': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Avoid variant inheritance ambiguity; document precedence rules for group vs child.',
              element4: 'Use variant mapping to align with product-level semantic tokens for analytics consistency.',
            },
            subtitle2: 'Best Practices',
            list2: {
              ...
              element4: 'Provide clear migration guidance if variant palettes change between versions.',
            },
          },
        },
      },
      card: {
        ...
        basic: {
          title: 'Basic Card',
          description: 'A simple card with a title and description to establish content hierarchy.',
          guidelines: {
            title: 'Guidelines',
            subtitle1: 'Usage',
            list1: {
              element1: 'Use for general layout grouping and lightweight summaries.',
              element2: 'Keep text concise for scan-friendly layouts.',
              element3: 'Pair with consistent spacing tokens for rhythm.',
              element4: 'Avoid heavy visuals unless the context requires them.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Use title + description for standard informational cards.',
              element2: 'Keep typography aligned with design tokens.',
              element3: 'Reserve bold emphasis for high-level labels only.',
              element4: 'Prefer semantic HTML for content blocks inside cards.',
            },
          },
        },
        'with-icon': {
          title: 'Card With Icon',
          description: 'Add a leading icon in the header to reinforce meaning or category.',
          guidelines: {
            title: 'Guidelines',
            subtitle1: 'Usage',
            list1: {
              element1: 'Use for status or category indicators.',
              element2: 'Keep icons subtle to avoid overpowering content.',
              element3: 'Align icon color with semantic intent when needed.',
              element4: 'Avoid mixing multiple icons in a single header.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Use the icon prop for consistent sizing and spacing.',
              element2: 'Prefer SVG icons for crisp rendering.',
              element3: 'Keep icon sizes consistent within a section.',
              element4: 'Ensure icons meet accessibility contrast requirements.',
            },
          },
        },
        'with-label': {
          title: 'Card With Label',
          description: 'Attach a label badge to highlight priority or status.',
          guidelines: {
            title: 'Guidelines',
            subtitle1: 'Usage',
            list1: {
              element1: 'Use labels for new, beta, or status metadata.',
              element2: 'Keep label text short and readable.',
              element3: 'Use one label per card for clarity.',
              element4: 'Match label colors to the semantic system.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Set label colors via the label prop.',
              element2: 'Ensure contrast for small text sizes.',
              element3: 'Avoid animated labels in content-heavy views.',
              element4: 'Use consistent label shapes across cards.',
            },
          },
        },
        'with-content': {
          title: 'Card With Content',
          description: 'Cards can render arbitrary children for action areas or custom layouts.',
          guidelines: {
            title: 'Guidelines',
            subtitle1: 'Usage',
            list1: {
              element1: 'Use for CTAs, forms, and interactive blocks.',
              element2: 'Keep layout simple to preserve focus.',
              element3: 'Limit to one primary action per card when possible.',
              element4: 'Use spacing to separate content from header text.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Wrap content in a single container for layout control.',
              element2: 'Avoid inline styles in production; use SCSS classes.',
              element3: 'Keep buttons aligned and evenly spaced.',
              element4: 'Respect card padding to prevent edge collisions.',
            },
          },
        },
        'full-header': {
          title: 'Full Header',
          description: 'Render title, icon, and label together for a stronger header hierarchy.',
          guidelines: {
            title: 'Guidelines',
            subtitle1: 'Usage',
            list1: {
              element1: 'Use for featured, pinned, or highlighted content.',
              element2: 'Keep the label short to avoid wrapping.',
              element3: 'Match icon color to your semantic palette.',
              element4: 'Avoid dense headers in small card sizes.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Use the card icon + label props for consistent layout.',
              element2: 'Prefer a single icon per header for clarity.',
              element3: 'Keep header content aligned to a single row.',
              element4: 'Use theme tokens for label colors.',
            },
          },
        },
        'with-actions': {
          title: 'Card With Actions',
          description: 'Pair card content with primary and secondary actions.',
          guidelines: {
            title: 'Guidelines',
            subtitle1: 'Usage',
            list1: {
              element1: 'Use when the card represents a task or workflow.',
              element2: 'Limit to one primary action per card.',
              element3: 'Use secondary actions sparingly to reduce noise.',
              element4: 'Align buttons to the card’s content flow.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Use consistent button sizes inside a card.',
              element2: 'Prefer outline for secondary actions.',
              element3: 'Keep spacing between actions uniform.',
              element4: 'Avoid full-width buttons unless required.',
            },
          },
        },
        'with-components': {
          title: 'Card With Components',
          description: 'Embed other UI components to create rich card layouts.',
          guidelines: {
            title: 'Guidelines',
            subtitle1: 'Usage',
            list1: {
              element1: 'Use for dashboards and composite widgets.',
              element2: 'Keep content density balanced for readability.',
              element3: 'Prefer vertical stacking for complex content.',
              element4: 'Use status components to highlight system state.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Group child components in a single container.',
              element2: 'Align components to a shared rhythm grid.',
              element3: 'Avoid mixing too many visual accents.',
              element4: 'Test responsiveness across breakpoints.',
            },
          },
        },
      },
      label: {
        ...
        installation: {
          ...
          description:
            'The above command is for individual installation of Label only. You may skip this step if <b>@aristobyte-ui</b> is already installed globally.',
        },
        import: {
          title: 'Import Label',
          description:
            'Use the Label component to keep badges consistent across your UI. Import it directly to standardize metadata styling.',
        },
        variants: {
          ...
          guidelines: {
            ...
            subtitle1: 'Usage',
            list1: {
              element1: 'Use <b>success</b> for positive status indicators.',
              element2: 'Use <b>warning</b> or <b>error</b> sparingly and intentionally.',
              element3: 'Reserve <b>primary</b> for key tags or highlights.',
              element4: 'Keep variant usage consistent across a page.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Align variant colors with your global token set.',
              element2: 'Ensure labels remain legible on dark and light surfaces.',
              element3: 'Avoid mixing too many variants in a single row.',
              element4: 'Keep label text short to prevent wrapping.',
            },
          },
        },
        appearance: {
          ...
          guidelines: {
            ...
            subtitle1: 'Usage',
            list1: {
              element1: 'Use outline for subtle metadata tags.',
              element2: 'Use solid for higher emphasis in dense UIs.',
              element3: 'Avoid glowing in crowded layouts.',
              element4: 'Use dashed for experimental or provisional tags.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Keep appearance consistent within a section.',
              element2: 'Test hover/contrast for each appearance.',
              element3: 'Avoid no-outline on low-contrast backgrounds.',
              element4: 'Use tokens to maintain consistency across themes.',
            },
          },
        },
        sizes: {
          ...
          guidelines: {
            ...
            subtitle1: 'Usage',
            list1: {
              element1: 'Use smaller sizes in tables and lists.',
              element2: 'Use larger sizes for headers or hero tags.',
              element3: 'Keep sizes consistent within a component group.',
              element4: 'Avoid oversized labels competing with titles.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Use size tokens rather than custom sizes.',
              element2: 'Maintain proportional padding for readability.',
              element3: 'Check alignment with surrounding typography.',
              element4: 'Avoid mixing sizes in a single row.',
            },
          },
        },
        radius: {
          ...
          guidelines: {
            ...
            subtitle1: 'Usage',
            list1: {
              element1: 'Match radius with nearby components for harmony.',
              element2: 'Use full radius for pill-like tags.',
              element3: 'Avoid mixing radius values in a single section.',
              element4: 'Keep radius consistent with button groups.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Prefer tokenized radius values.',
              element2: 'Test on small sizes to avoid clipping.',
              element3: 'Keep radius changes subtle for metadata labels.',
              element4: 'Document radius usage in design guidelines.',
            },
          },
        },
        colors: {
          ...
          guidelines: {
            ...
            subtitle1: 'Usage',
            list1: {
              element1: 'Use custom colors for brand-specific badges.',
              element2: 'Ensure contrast meets accessibility thresholds.',
              element3: 'Keep custom color usage consistent across pages.',
              element4: 'Avoid too many bespoke colors in the same view.',
            },
            subtitle2: 'Implementation',
            list2: {
              element1: 'Use Label color props to override defaults.',
              element2: 'Prefer translucent backgrounds for dense layouts.',
              element3: 'Document meaning for non-semantic colors.',
              element4: 'Validate appearance in dark mode if supported.',
            },
          },
        },
      },
      spinner: {
        ...
        types: {
          title: 'Spinner Appearances',
          description:
            'AristoByte UI offers five spinner appearances — <b>default</b>, <b>duo</b>, <b>gradient</b>, <b>pulse</b>, and <b>pulse-duo</b>. Each appearance provides a distinct animation style suited for different loading scenarios, from inline feedback to full-screen blocking loaders.',
          guidelines: {
            title: 'Guidelines',
            subtitle1: 'When to Use',
            list1: {
              element1: 'Use simple types for inline indicators; complex for standalone loaders.',
              element2: 'Prefer non-blocking spinners within content regions.',
              element3: 'Choose duo/gradient types for brand-centric hero loaders where motion complements identity.',
              element4: 'Use pulse types sparingly in high-density pages to avoid visual fatigue.',
            },
            subtitle2: 'Performance Considerations',
            list2: {
              element1: 'Avoid overly decorative types in enterprise workflows.',
              element2: 'Ensure animation performance stays under 60fps budget.',
              element3: 'Fallback to static indicators in reduced-motion user settings.',
              element4: 'Keep DOM footprint minimal for spinner variants used frequently in lists.',
            },
          },
        },
        variants: {
          ...
          guidelines: {
            ...
            list1: {
              element1: "Map variant color to the underlying operation's intent.",
              element2: 'Use neutral variants for generic background loading.',
              element3: 'Avoid color semantics that conflict with surrounding alerts or messages.',
              element4: 'Document variant palette so consumers can choose consistent intent across components.',
            },
            subtitle2: 'Best Practices',
            list2: {
              element1: 'Maintain contrast against the host surface.',
              element2: 'Avoid red unless signaling error-state recovery.',
              element3: 'Provide tokenized color fallbacks for consumer themes that override core palettes.',
              element4: 'Test spinner visibility across density and scale settings in OS accessibility panels.',
            },
          },
        },
        sizes: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element2: 'Use large/x-large for blocking overlays or empty states.',
              element3: 'Prefer size tokens aligned to component density metrics to ensure cohesive scaling.',
              element4: 'Use larger spinners for empty-state placeholders to center user attention.',
            },
            subtitle2: 'Implementation Notes',
            list2: {
              element1: 'Keep spinner size proportional to containing control.',
              element2: 'Avoid oversized loaders that shift layout.',
              element3: 'Expose size props rather than hard-coded CSS so consumers can adapt programmatically.',
              element4: 'Validate spinner sizing on retina and high-DPI displays to prevent pixelation.',
            },
          },
        },
      },
        ...
        variants: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Select success for completed flows and error for actionable failures.',
              element4:
                'Use warning for recoverable states that require user attention but not immediate interruption.',
            },
            subtitle2: 'Remediation & UX',
            list2: {
              element1: 'Do not use success/error for purely informational content.',
              element2: 'Keep messages concise with a clear remediation path.',
              element3: 'Provide clear CTA or link to remediation when the message signals user action.',
              element4: 'Expose machine-readable codes (data-error-code) to facilitate automated monitoring.',
            },
          },
        },
        types: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Prefer dashed outlines for provisional or beta notices to indicate lower fidelity.',
              element4:
            ...
            list2: {
              ...
              element3: 'Consistently apply padding and margin tokens across types to avoid layout drift.',
              element4: 'Make sure visual weight of type matches its semantic urgency to avoid false alarms.',
            },
          },
        },
        radius: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Prefer consistent radius tokens across notification stacks to prevent visual clutter.',
              element4: 'When using full radius, ensure clipping does not hide important message content.',
            },
            subtitle2: 'Best Practices',
            list2: {
              element1: 'Avoid mixing multiple radii within one notification stack.',
              element2: 'Respect container clipping for overflowed radii.',
              element3: 'Test radius combinations on responsive breakpoints to prevent overlap with container edges.',
              element4: 'Document radius trade-offs for dense dashboards vs marketing surfaces.',
            },
          },
        },
        'without-icon': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use icon-less variants for compact lists of system messages to reduce visual density.',
              element4: 'Prefer without-icon in high-volume notification feeds to maintain scanning efficiency.',
            },
            subtitle2: 'Content Strategy',
            list2: {
              element1: 'Ensure copy provides sufficient context without an icon.',
              element2: 'Do not remove icons for critical alerts.',
              element3: 'Add succinct actionable copy or link to compensate for the missing visual cue.',
              element4: 'Run readability checks on multi-locale content when icons are omitted to ensure clarity.',
            },
          },
        },
      },
        ...
        labeled: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Prefer concise labels (2-4 words) that map directly to backend fields.',
              element4: 'When space permits, include a short helper to explain complex toggle behavior.',
            },
            subtitle2: 'Accessibility & Implementation',
            list2: {
              element1: 'Associate label via <label for> or aria-labelledby.',
              element2: 'Keep label copy concise (2-4 words).',
              element3: 'Ensure label changes are announced by screen readers when state toggles programmatically.',
              element4: 'Provide test IDs for labels to support UI automation and telemetry correlation.',
            },
          },
        },
        disabled: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use disabled state to indicate server-derived read-only configuration in settings pages.',
              element4:
            ...
            list2: {
              ...
              element4: 'Do not rely on visual disabled state for security — enforce permission checks server-side.',
            },
          },
        },
        'align-label': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use responsive alignment to shift between horizontal/vertical based on available width.',
              element4: 'Prefer vertical alignment for forms where label wrapping is likely to improve readability.',
            },
            subtitle2: 'Implementation Notes',
            list2: {
              element1: 'Ensure click target includes label and control.',
              element2: 'Maintain consistent alignment across a section.',
              element3: 'When aligning horizontally, ensure the label remains accessible via keyboard navigation.',
              element4:
        ...
        variants: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Map variants to backend meaning when toggles correspond to persistent feature flags.',
              element4: 'Reserve warning colors for toggles that may cause visible UX changes or require confirmation.',
            },
            subtitle2: 'Accessibility Notes',
            list2: {
              element1: 'Respect contrast and WCAG state colors.',
              element2: 'Avoid alarming colors for benign toggles.',
              element3: 'Ensure variant colors are still distinguishable for color-blind users (use shape + color).',
              element4: 'Provide tokenized theming for variant overrides so clients can maintain high contrast.',
            },
          },
        },
        sizes: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Select sizes that maintain a minimum thumb grab area for touch devices.',
              element4:
            ...
            list2: {
              ...
              element3: 'Document how size impacts layout and provide examples for responsive design.',
              element4: 'Create snapshot tests for each size to catch visual regressions across themes.',
            },
          },
        },
        checked: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use <b>checked</b> to mirror persisted user preferences when rendering forms.',
              element4: 'Avoid pre-checking toggles that result in billing or destructive behavior.',
            },
            subtitle2: 'Best Practices',
            list2: {
              element1: 'Avoid dark patterns; never pre-enable risky toggles.',
              element2: 'Sync initial state with persisted user preferences.',
              element3: 'Provide explicit documentation for initial checked semantics to prevent integration errors.',
              element4: 'When migrating defaults, communicate breaking changes in release notes and deprecation paths.',
            },
          },
        },
        controlled: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element4: 'Use controlled pattern for toggles that affect other components or persist to remote stores.',
            },
            subtitle2: 'Developer Notes',
            list2: {
              element1: 'Debounce writes if persisting remotely.',
              element2: 'Always implement onChange with idempotent handlers.',
              element3: 'Consider optimistic UI updates with rollback paths for failed persistence.',
              element4: 'Document expected event payload structure to ensure consistent consumer implementations.',
            },
          },
        },
        'track-icon': {
          ...
          guidelines: {
            ...
            subtitle1: 'Design Considerations',
            list1: {
              element1: 'Use icons to reinforce domain meaning (e.g., eye/eye-off).',
              element2: 'Use sparingly to avoid visual noise.',
              element3: 'Ensure icons are legible across sizes and themes; consider stroke weight consistency.',
              element4: 'Prefer subtle icons that act as affordances rather than decorative elements.',
            },
            subtitle2: 'Best Practices',
            list2: {
              element1: 'Keep icons subtle and size-aligned to the track.',
              element2: 'Ensure icons remain legible at all sizes.',
              element3: 'Provide non-icon alternatives for assistive tech consumers (aria-label fallback).',
              element4: 'Avoid adding heavy SVGs that increase bundle size for frequently-rendered switches.',
            },
          },
        },
        'thumb-icon': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use for clearly semantic controls like power toggles where icon adds immediate recognition.',
              element4: 'Avoid for generic settings where icon could reduce readability.',
            },
            subtitle2: 'Developer Tips',
            list2: {
              element1: 'Keep contrast sufficient against the thumb color.',
              element2: 'Do not animate icons independently of the thumb.',
              element3: 'Provide scalable vector icons to avoid pixelation at large sizes.',
              element4: 'Document accessibility expectations when thumb icons replace textual cues.',
            },
          },
        },
      },
        ...
        disabled: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use group-level disable to reflect read-only server side settings consistently.',
              element4: 'Disable radios when subsequent steps depend on a confirmed upstream state.',
            },
            subtitle2: 'Developer Guidance',
            list2: {
              element1: 'Explain disabled state via helper text.',
              element2: 'Keep visual distinction clear from unchecked state.',
              element3: 'Provide ARIA roles and descriptions to clarify disabled semantics for assistive tech.',
              element4: 'Document how overrides behave when both group and individual radios are marked disabled.',
            },
          },
        },
        sizes: {
          ...
          guidelines: {
            ...
            list1: {
              element1: 'Use small for dense filters; large for touch-first UIs.',
              element2: 'Scale with type ramp to maintain rhythm.',
              element3: 'Prefer nominal sizes that map to global type-scale tokens for predictable layout.',
              element4: 'Avoid using extremes simultaneously in the same form to prevent visual dissonance.',
            },
            subtitle2: 'Best Practices',
            list2: {
              element1: 'Ensure labels remain readable at smaller sizes.',
              element2: 'Maintain a11y hit area even when visually compact.',
              element3: 'Document how size interacts with label wrapping and alignment in responsive contexts.',
              element4: 'Include unit tests to assert the hit-target minimum dimensions across sizes.',
            },
          },
        },
        variants: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use variants to visually group related options that map to different operational modes.',
              element4: 'Avoid semantic variants for purely ornamental radios to prevent misuse by consumers.',
            },
            ...
            list2: {
              ...
              element3: 'Provide a token map document for variant-to-token relationships for integrators.',
              element4: 'Test variant rendering across brand themes to catch token overrides that reduce contrast.',
            },
          },
        },
        appearance: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Reserve <b>glowing</b> appearance for focused callouts or onboarding flows.',
              element4: 'Choose no-outline when embedding radios into fully illustrated or branded surfaces.',
            },
            ...
            list2: {
              ...
              element3: 'Document visual hierarchy for appearance options to help consumers choose appropriately.',
              element4: 'Ensure appearance options have consistent hover/focus interactions to avoid surprises.',
            },
          },
        },
        'highlight-label': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use highlightLabel for compact decision UIs where color reinforces selection.',
              element4: 'Avoid highlightLabel in dense dashboards where color overload reduces scanability.',
            },
            subtitle2: 'Design Notes',
            list2: {
              element1: 'Maintain accessible color contrast on labels.',
              element2: "Ensure highlight doesn't imply clickability when disabled.",
              element3: 'Provide option to programmatically toggle highlight for testing visual regressions.',
              element4: 'Document highlight behavior for both group and individual radio overrides.',
            },
          },
        },
        'radio-group-align': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'When horizontal wrapping occurs, ensure each radio remains a separate focus target.',
              element4:
            ...
            list2: {
              ...
              element3: 'Provide responsive examples in docs to show how alignment adapts across breakpoints.',
              element4: 'Consider alignment interactions with flex/grid containers to prevent overflow.',
            },
          },
        },
        'align-label': {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use top alignment for prominent labels that should read before the control.',
              element4: 'Use left/right alignment for multi-column forms to save vertical space.',
            },
            subtitle2: 'Developer Notes',
            list2: {
              element1: 'Ensure label remains clickable with the control.',
              element2: 'Keep alignment consistent across a group.',
              element3: 'Account for different languages and label lengths when choosing alignment to avoid overflow.',
              element4: 'Provide a11y examples showing label association across alignment permutations.',
            },
          },
        },
        controlled: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Use controlled pattern to coordinate dependent form fields and derived state.',
              element4: 'Avoid mixing uncontrolled radios in a controlled group to prevent unpredictable behavior.',
            },
            subtitle2: 'Implementation Notes',
            list2: {
              element1: 'Treat value as immutable; update via onChange only.',
              element2: 'Keep controlled and uncontrolled patterns separate.',
              element3: 'Provide clear example code snippets for controlled/uncontrolled patterns in docs.',
              element4: 'Debounce heavy updates triggered by radio changes to avoid thrashing connected systems.',
            },
          },
        },
      },
      dropdown: {
        ...
        usage: {
          ...
          guidelines: {
            ...
            subtitle1: 'Usage',
            list1: {
              element1: 'Keep option labels concise and scannable.',
              element2: 'Provide short descriptions for complex choices.',
              element3: 'Use meaningful default values where appropriate.',
              element4: 'Avoid overloading a single dropdown with too many options.',
            },
            subtitle2: 'Implementation Notes',
            list2: {
              element1: 'Keep values stable for form submissions.',
              element2: 'Use placeholders that describe the action.',
              element3: 'Ensure keyboard navigation is preserved.',
              element4: 'Add analytics hooks where selection matters.',
            },
          },
        },
        disabled: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Disable when server-side flags indicate the selection is currently immutable.',
              element4: 'Use disabled dropdowns as placeholders while remote option lists are being fetched.',
            },
            ...
            list2: {
              ...
              element3: 'Preserve semantic markup (select/option) for accessibility even when visually disabled.',
              element4: 'Document keyboard behavior and focus management for disabled dropdowns.',
            },
          },
        },
        appearance: {
          ...
          guidelines: {
            ...
            list1: {
              element1: 'Use outline for standard forms; solid for high-contrast UIs.',
              element2: 'Use no-outline in minimal surfaces with strong backgrounds.',
              element3:
                'Choose glowing only when the dropdown needs to attract attention in onboarding or spotlight flows.',
              element4: 'Prefer dashed outlines for experimental UI patterns to indicate tentative styling.',
            },
            subtitle2: 'Implementation Notes',
            list2: {
              element1: 'Keep placeholder text distinct from selected value.',
              element2: 'Ensure focus/hover states are clearly visible.',
              element3: 'Provide accessible labeling and ensure appearance changes do not remove focus indicators.',
              element4:
        ...
        multiple: {
          ...
          guidelines: {
            ...
            subtitle1: 'Usage',
            list1: {
              element1: 'Use multi-select sparingly; prefer checklists for long lists.',
              element2: 'Keep the selected state visible and clear.',
              element3: 'Use concise option labels to reduce visual noise.',
              element4: 'Provide a way to clear selections quickly.',
            },
            subtitle2: 'Implementation Notes',
            list2: {
              element1: 'Use the <b>choice</b> prop set to <b>multiple</b>.',
              element2: 'Keep selection state consistent when re-rendering.',
              element3: 'Avoid auto-closing when selecting multiple items.',
              element4: 'Test selection behavior across keyboard and mouse.',
            },
          },
        },
      },
        ...
        disabled: {
          ...
          guidelines: {
            ...
            list1: {
              ...
              element3: 'Suppress share/like CTA when privacy or consent flags are unresolved for the content owner.',
              element4:
            ...
            list2: {
              element1: 'Render explanatory microcopy or tooltip to communicate why actions are disabled.',
              element2:
                'Keep visible metadata (likes, timestamp) readable even when interactive controls are disabled.',
              element3: 'Provide a programmatic reason code (data-disabled-reason) for telemetry and automated tests.',
              element4: 'Ensure disabled styling is keyboard- and screen-reader-friendly; maintain semantic DOM order.',
            },
          },
        },
      },
