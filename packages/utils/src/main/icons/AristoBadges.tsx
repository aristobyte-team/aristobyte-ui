...
export const AristoBadges = ({ size: size = 24 }: IconPropsType) => (
  <svg
    ...
    id="uuid-6083a255-3678-4889-aa78-1c0382f87526"
    viewBox="0 0 400 460"
  >
    <defs>
      <linearGradient
        id="uuid-5f364422-dc4c-4152-a958-8cb89cbedcb4"
        x1="197.19"
        y1="307.66"
        x2="201.32"
        y2="14.72"
      ...
      <linearGradient
        id="uuid-632df4d8-7dae-413a-9335-acac7412d2f2"
        x1="251.05"
        y1="411.14"
        x2="247.1"
        y2="209.26"
    ...
    <g id="uuid-b0814c43-a549-4954-ba93-5c35d7ce4383">
      <path
        id="uuid-8329ad40-6caa-4380-8d8d-b6f9a0e643cb"
        ...
        fill="url(#uuid-5f364422-dc4c-4152-a958-8cb89cbedcb4)"
        filter="url(#uuid-d5b6607b-c345-49e4-a776-c86679dba1e1)"
      />
      <path
        id="uuid-d19a2cfa-cf7e-454c-9477-90ce8d3ebde1"
