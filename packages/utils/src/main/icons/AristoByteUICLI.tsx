...
export const AristoByteUICLI = ({ size = 24 }: IconPropsType) => {
  ...
  >
    <defs>
      ...
      >
        <stop offset="0" stopColor="#fcb118" />
        <stop offset=".18" stopColor="#f79120" />
        <stop offset=".36" stopColor="#f68a21" />
        <stop offset=".54" stopColor="#f47c20" />
        <stop offset=".7" stopColor="#f37024" />
        <stop offset=".86" stopColor="#f15f24" />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".54" stopColor="#161321" />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor="#f8951d" />
        <stop offset=".18" stopColor="#f36d21" />
        <stop offset=".36" stopColor="#f16022" />
        <stop offset=".54" stopColor="#ef3924" />
        <stop offset=".7" stopColor="#ee3724" />
        <stop offset=".86" stopColor="#ee3724" />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor="#f04f23" />
        <stop offset=".18" stopColor="#e53225" />
        <stop offset=".36" stopColor="#e93224" />
        <stop offset=".55" stopColor="#df2d26" />
        <stop offset=".7" stopColor="#d02727" />
        <stop offset=".86" stopColor="#cd2527" />
