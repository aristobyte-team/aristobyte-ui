...
export const AristoByteUI = ({ size = 24 }: IconPropsType) => (
  ...
  >
    <defs>
      ...
      <linearGradient
        id="aristobyte-linear-gradient-1"
        x1="111.59"
        y1="765.68"
        x2="806.58"
        y2="765.68"
      ...
      <linearGradient
        id="aristobyte-linear-gradient-2"
        x1="111.59"
        y1="651.81"
        x2="806.59"
        y2="651.81"
      ...
      <linearGradient
        id="aristobyte-linear-gradient-3"
        x1="111.59"
        y1="623.26"
        x2="806.58"
        y2="623.26"
      ...
      <linearGradient
        id="aristobyte-linear-gradient-4"
        x1="111.59"
        y1="509.4"
        x2="806.59"
        y2="509.4"
      ...
      <linearGradient
        id="aristobyte-linear-gradient-5"
        x1="111.59"
        y1="366.98"
        x2="806.59"
        y2="366.98"
    ...
    <g id="logo">
      <g id="g-3" filter="url(#drop-shadow-1)">
        <path
          ...
          fill="url(#aristobyte-linear-gradient-1)"
        />
        <path
          id="surf-3"
          ...
          fill="url(#aristobyte-linear-gradient-2)"
        />
      </g>
      ...
      <g id="g-1" filter="url(#drop-shadow-3)">
        ...
        <g id="surf-1">
          <path
            ...
            fill="url(#aristobyte-linear-gradient-5)"
          />
        </g>
      </g>
    </g>
