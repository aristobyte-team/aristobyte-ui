...
export const Bun = ({ size = 24 }: IconPropsType) => (
  <svg viewBox="0 0 80 70" width={size} height={size}>
    ...
    <g id="Face">
      <ellipse id="Right_Blush" data-name="Right Blush" cx="53.22" cy="40.18" rx="5.85" ry="3.44" fill="#febbd0" />
      <ellipse id="Left_Bluch" data-name="Left Bluch" cx="22.95" cy="40.18" rx="5.85" ry="3.44" fill="#febbd0" />
      <path
        id="Eyes"
