...
export const Dna = (props: React.SVGProps<SVGSVGElement>) => {
  ...
  const secondaryGradientId = `${uid}-dna-secondary-gradient`;
  const tertiaryGradientId = `${uid}-dna-tertiary-gradient`;
  ...
  return (
    ...
    >
      ...
      <path
        d="M12,9s0,0,.1,0c.4,0,.7-.2.9-.5l.2.2c.2.2.5.3.7.3s.5,0,.7-.3c.4-.4.4-1,0-1.4l-1.1-1.1c.2-.5.4-1,.7-1.5l2,2c.2.2.5.3.7.3s.5,0,.7-.3c.4-.4.4-1,0-1.4l-2.3-2.3c0-.1.2-.2.3-.4.4-.4.3-1,0-1.4-.4-.4-1-.3-1.4,0-1.7,1.9-2.7,4-3.1,6.5,0,.5.3,1.1.8,1.1Z"
      ...
      />
      <path
        d="M12,15c-.4,0-.8.2-1,.5l-.2-.2c-.4-.4-1-.4-1.4,0s-.4,1,0,1.4l1.1,1.1c-.2.5-.4,1-.7,1.5l-2-2c-.4-.4-1-.4-1.4,0s-.4,1,0,1.4l2.3,2.3c0,.1-.2.2-.3.4-.4.4-.3,1,0,1.4.2.2.4.3.7.3s.5-.1.7-.3c1.7-1.9,2.7-4,3.1-6.5,0-.5-.3-1.1-.8-1.1Z"
