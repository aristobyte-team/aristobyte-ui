  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        x2="1105.92"
        y2="875.56"
        xlinkHref="#aristobyte-linear-gradient"
      />
      <linearGradient
      ...
      />
      <linearGradient
        id="aristobyte-linear-gradient-6"
        data-name="Оранжевый, желтый"
        y1="276.36"
        y2="276.36"
        xlinkHref="#aristobyte-linear-gradient"
        ...
        <g id="layer-1-2" data-name="Слой 1">
          <g id="Logo">
            ...
            <g>
              <g>
                <path
                  fill="url(#aristobyte-linear-gradient)"
                ...
                />
                <path
                  fill="url(#aristobyte-linear-gradient-6)"
