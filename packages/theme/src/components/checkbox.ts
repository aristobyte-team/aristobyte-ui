  ...
  variants: {
    ...
    size: {
      sm: {
        wrapper: [
          "w-4 h-4 me-2",
          "rounded-[calc(var(--aristobyteui-radius-medium)*0.5)]",
          "before:rounded-[calc(var(--aristobyteui-radius-medium)*0.5)]",
          "after:rounded-[calc(var(--aristobyteui-radius-medium)*0.5)]",
        ],
        label: "text-small",
        icon: "w-3 h-2",
      },
      md: {
        wrapper: [
          "w-5 h-5 me-2",
          "rounded-[calc(var(--aristobyteui-radius-medium)*0.6)]",
          "before:rounded-[calc(var(--aristobyteui-radius-medium)*0.6)]",
          "after:rounded-[calc(var(--aristobyteui-radius-medium)*0.6)]",
        ],
        label: "text-medium",
        icon: "w-4 h-3",
      },
      lg: {
        wrapper: [
          "w-6 h-6 me-2",
          "rounded-[calc(var(--aristobyteui-radius-medium)*0.7)]",
          "before:rounded-[calc(var(--aristobyteui-radius-medium)*0.7)]",
          "after:rounded-[calc(var(--aristobyteui-radius-medium)*0.7)]",
        ],
        label: "text-large",
        icon: "w-5 h-4",
      },
