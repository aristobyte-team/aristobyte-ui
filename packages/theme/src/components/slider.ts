...
const slider = tv({
  ...
  variants: {
    ...
    radius: {
      ...
      sm: {
        thumb:
          "rounded-[calc(var(--aristobyteui-radius-small)/2)] after:rounded-[calc(var(--aristobyteui-radius-small)/3)]",
      },
      md: {
        thumb:
          "rounded-[calc(var(--aristobyteui-radius-medium)/2)] after:rounded-[calc(var(--aristobyteui-radius-medium)/3)]",
      },
      lg: {
        thumb:
          "rounded-[calc(var(--aristobyteui-radius-large)/1.5)] after:rounded-[calc(var(--aristobyteui-radius-large)/2)]",
      },
      full: {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      class: {
        track:
          "data-[fill-start=true]:border-s-secondary data-[fill-end=true]:border-e-secondary",
      },
    },
    {
      color: "success",
      ...
      class: {
        track:
          "data-[fill-start=true]:border-s-success data-[fill-end=true]:border-e-success",
      },
    },
    {
      color: "warning",
      ...
      class: {
        track:
          "data-[fill-start=true]:border-s-warning data-[fill-end=true]:border-e-warning",
      },
    },
    {
      color: "danger",
      ...
      class: {
        track:
          "data-[fill-start=true]:border-s-danger data-[fill-end=true]:border-e-danger",
      },
    },
    // color && isVertical
    {
    ...
    },
    {
      ...
      class: {
        track:
          "data-[fill-start=true]:border-b-secondary data-[fill-end=true]:border-t-secondary",
      },
    },
    {
      color: "success",
      ...
      class: {
        track:
          "data-[fill-start=true]:border-b-success data-[fill-end=true]:border-t-success",
      },
    },
    {
      color: "warning",
      ...
      class: {
        track:
          "data-[fill-start=true]:border-b-warning data-[fill-end=true]:border-t-warning",
      },
    },
    {
      color: "danger",
      ...
      class: {
        track:
          "data-[fill-start=true]:border-b-danger data-[fill-end=true]:border-t-danger",
      },
    },
  ],
  defaultVariants: {
